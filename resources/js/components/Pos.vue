                     ...
                     <div class="col-md-3" v-for="product in allproduct" :key="product.id" >
                        <figure class="card card-product">
                           ...
                           <figcaption class="info-wrap">
                              ...
                              <a href="#" class="title">
                                 <barcode v-bind:value="product.id" height="50px">Show this if the rendering fails.</barcode>
                              </a>
                              <br/>
...
export default {
    ...
    methods:{
           onDecode(a, b, c) {
              ...
              this.id = setTimeout(() => {
                if (this.text === a) {
                 axios.get('api/product-add-tocart/'+a)
                       .then(response=>{
      ...
      //   onDecode (result) 
      //   { 
      //       axios.get('api/product-add-tocart/'+result)
      //          .then(response=>{
      //             if(response.data.status == 1)
      //             {
      //                this.getCartProduct();
